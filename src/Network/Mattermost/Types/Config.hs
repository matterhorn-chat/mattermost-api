...
instance A.ToJSON ClientConfig where
  toJSON c = A.object
    [ "Version" A..= clientConfigVersion c
    , "BuildNumber" A..= clientConfigBuildNumber c
    , "BuildDate" A..= clientConfigBuildDate c
    , "BuildHash" A..= clientConfigBuildHash c
    , "BuildHashEnterprise" A..= clientConfigBuildHashEnterprise c
    , "BuildEnterpriseReady" A..= clientConfigBuildEnterpriseReady c
    , "SiteURL" A..= clientConfigSiteURL c
    , "SiteName" A..= clientConfigSiteName c
    , "EnableTeamCreation" A..= clientConfigEnableTeamCreation c
    , "EnableOpenServer" A..= clientConfigEnableOpenServer c
    , "RestrictDirectMessage" A..= clientConfigRestrictDirectMessage c
    , "RestrictTeamInvite" A..= clientConfigRestrictTeamInvite c
    , "RestrictPublicChannelCreation" A..= clientConfigRestrictPublicChannelCreation c
    , "RestrictPrivateChannelCreation" A..= clientConfigRestrictPrivateChannelCreation c
    , "RestrictPublicChannelManagement" A..= clientConfigRestrictPublicChannelManagement c
    , "RestrictPrivateChannelManagement" A..= clientConfigRestrictPrivateChannelManagement c
    , "RestrictPublicChannelDeletion" A..= clientConfigRestrictPublicChannelDeletion c
    , "RestrictPrivateChannelDeletion" A..= clientConfigRestrictPrivateChannelDeletion c
    , "RestrictPrivateChannelManageMembers" A..= clientConfigRestrictPrivateChannelManageMembers c
    , "TeammateNameDisplay" A..= clientConfigTeammateNameDisplay c
    , "EnableOAuthServiceProvider" A..= clientConfigEnableOAuthServiceProvider c
    , "GoogleDeveloperKey" A..= clientConfigGoogleDeveloperKey c
    , "EnableIncomingWebhooks" A..= clientConfigEnableIncomingWebhooks c
    , "EnableOutgoingWebhooks" A..= clientConfigEnableOutgoingWebhooks c
    , "EnableCommands" A..= clientConfigEnableCommands c
    , "EnableOnlyAdminIntegrations" A..= clientConfigEnableOnlyAdminIntegrations c
    , "EnablePostUsernameOverride" A..= clientConfigEnablePostUsernameOverride c
    , "EnablePostIconOverride" A..= clientConfigEnablePostIconOverride c
    , "EnableLinkPreviews" A..= clientConfigEnableLinkPreviews c
    , "EnableTesting" A..= clientConfigEnableTesting c
    , "EnableDeveloper" A..= clientConfigEnableDeveloper c
    , "EnableDiagnostics" A..= clientConfigEnableDiagnostics c
    , "RestrictPostDelete" A..= clientConfigRestrictPostDelete c
    , "AllowEditPost" A..= clientConfigAllowEditPost c
    , "PostEditTimeLimit" A..= clientConfigPostEditTimeLimit c
    , "SendEmailNotifications" A..= clientConfigSendEmailNotifications c
    , "SendPushNotifications" A..= clientConfigSendPushNotifications c
    , "EnableSignUpWithEmail" A..= clientConfigEnableSignUpWithEmail c
    , "EnableSignInWithEmail" A..= clientConfigEnableSignInWithEmail c
    , "EnableSignInWithUsername" A..= clientConfigEnableSignInWithUsername c
    , "RequireEmailVerification" A..= clientConfigRequireEmailVerification c
    , "EnableEmailBatching" A..= clientConfigEnableEmailBatching c
    , "EnableSignUpWithGitLab" A..= clientConfigEnableSignUpWithGitLab c
    , "ShowEmailAddress" A..= clientConfigShowEmailAddress c
    , "TermsOfServiceLink" A..= clientConfigTermsOfServiceLink c
    , "PrivacyPolicyLink" A..= clientConfigPrivacyPolicyLink c
    , "AboutLink" A..= clientConfigAboutLink c
    , "HelpLink" A..= clientConfigHelpLink c
    , "ReportAProblemLink" A..= clientConfigReportAProblemLink c
    , "AdministratorsGuideLink" A..= clientConfigAdministratorsGuideLink c
    , "TroubleshootingForumLink" A..= clientConfigTroubleshootingForumLink c
    , "CommercialSupportLink" A..= clientConfigCommercialSupportLink c
    , "SupportEmail" A..= clientConfigSupportEmail c
    , "EnableFileAttachments" A..= clientConfigEnableFileAttachments c
    , "EnablePublicLink" A..= clientConfigEnablePublicLink c
    , "WebsocketPort" A..= clientConfigWebsocketPort c
    , "WebsocketSecurePort" A..= clientConfigWebsocketSecurePort c
    , "DefaultClientLocale" A..= clientConfigDefaultClientLocale c
    , "AvailableLocales" A..= clientConfigAvailableLocales c
    , "SQLDriverName" A..= clientConfigSQLDriverName c
    , "EnableCustomEmoji" A..= clientConfigEnableCustomEmoji c
    , "EnableEmojiPicker" A..= clientConfigEnableEmojiPicker c
    , "RestrictCustomEmojiCreation" A..= clientConfigRestrictCustomEmojiCreation c
    , "MaxFileSize" A..= clientConfigMaxFileSize c
    , "AppDownloadLink" A..= clientConfigAppDownloadLink c
    , "AndroidAppDownloadLink" A..= clientConfigAndroidAppDownloadLink c
    , "IosAppDownloadLink" A..= clientConfigIosAppDownloadLink c
    , "EnableWebrtc" A..= clientConfigEnableWebrtc c
    , "MaxNotificationsPerChannel" A..= clientConfigMaxNotificationsPerChannel c
    , "TimeBetweenUserTypingUpdatesMilliseconds" A..= clientConfigTimeBetweenUserTypingUpdatesMilliseconds c
    , "EnableUserTypingMessages" A..= clientConfigEnableUserTypingMessages c
    , "EnableChannelViewedMessages" A..= clientConfigEnableChannelViewedMessages c
    , "DiagnosticId" A..= clientConfigDiagnosticId c
    , "DiagnosticsEnabled" A..= clientConfigDiagnosticsEnabled c
    ]
